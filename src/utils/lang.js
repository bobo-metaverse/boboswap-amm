const ch2en = {
  ...
  '输入的通证地址不存在，请检查后输入': 'The id of the transferred asset is incorrect. Please re-enter',
  ...
  选择通证: 'Select ASSET',
  敬请期待: 'Coming soon...',
  选择此通证: 'Select the asset',
  '持有账户数:': 'Accounts held：',
  '流动性/个': 'Pairs',
  退出流动池: 'quit',
  '通过地址搜索通证': 'Search for assets by Token Address/ asset full name',
  ...
  请选择需要操作通证的账户: 'Please select account which will operate asset',
  请选择需要更新关联合约的通证地址: 'Please select token address which will bind to contract',
  合约账户不存在: " Contract account isn't exist.",
  需改变创办者的通证: 'Asset',
  需改变合约的通证: 'Asset',
  置空则为非协议通证: 'non contract asset could be set to null',
  提交: 'submit',
  请输入待销毁通证金额: 'Please input value of asset destroyed',
  销毁金额不能超过您所拥有的通证总额: "the destroyed value of asset can't beyond your total asset balance.",
  需销毁的通证: 'Asset',
  ...
  待增发通证: 'Asset',
  选择需要增发的通证地址: 'Please select asset',
  增发金额: 'value',
  增发对象: 'account',
  将通证增发给此账号: 'increase asset to account',
  通证名称错误: 'asset name is error',
  通证已存在: 'asset has been exist',
  '通证名同账号名冲突，不可用': 'asset name conflict with account name',
  '由于父通证的管理者不属于此账户，因此无法创建此子通证': "Can't create sub asset",
  通证符号错误: 'asset symbol is error',
  通证金额必须大于0: 'asset value must be bigger than 0',
  请输入正确的精度: 'Please input correct decimals',
  管理者账户不存在: 'manager account not exist',
  创办者不存在: 'founder not exist',
  通证上限必须大于等于通证发行金额: 'asset upper limit should bigger than issue value',
  请输入正确的通证名称: 'please input correct asset name',
  不可跟已有的通证和账户名冲突: 'name conflict',
  请输入正确的通证符号: 'input correct asset symbol',
  符号: 'symbol',
  ...
  精度: 'decimals',
  管理者: 'manager',
  可对此通证进行管理: 'can manage the asset',
  可收取相关手续费: 'can get gas fee',
  增发上限: 'upper limit of increase asset',
  '通证增发上限,0表示无上限': 'upper limit,0 is limitless',
  留空表示非协议通证: 'null is not contract asset',
  通证描述: 'asset description',
  通证操作: 'asset operate',
  选择发起通证操作的账户: 'select account to operate asset',
  发行通证: 'Issue Asset',
  增发通证: 'Increate Asset',
  设置通证管理者: 'Set Asset Manager',
  设置通证创办者: 'Set Asset Founder',
  设置协议通证: 'Set Contract Asset',
  销毁通证: 'Destroy Asset',
  请选择需要操作通证的账户: 'Please select account to operate asset',
  ...
  无此通证信息: 'no asset info',
  用户通证信息: 'User Asset Info',
  用户账号: 'user account',
  通证发行信息: 'Asset Issue Info',
  '通证地址/通证名称': 'token address/name',
  创建区块高度: 'block height',
  已发行量: 'issued value',
  创建人: 'founder',
  增发量: 'increase value',
  通证上限: 'asset upper limit',
  描述: 'description',
  ...
  父子通证的精度必须保持一致: 'The decimals of father and sub asset should be equal.',
  ...
  父通证不存在: 'Father asset is not exist',
  账号设置: 'Account',
  设置接入节点: 'Node Setting',
  '主网：': 'Mainnet:',
  '主网1：': 'Mainnet 1:',
  ...
  私网: 'Private Net',
  通证: 'Asset',
  '格式：‘账户名:通证名’': 'format: ‘accountName:assetName’',
  ...
  发生于: ' at ',
  块龄: 'Time',
  用户通证信息查询: 'User Asset Info',
  通证发行信息查询: 'Asset Issue Info',
  账户名: 'Account',
  通证描述: 'Asset Description',
  确定: 'OK',
  '高度/哈希': 'height/hash',
